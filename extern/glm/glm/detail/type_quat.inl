...
{
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR static T call(qua < T, Q >
    const& a,
    qua <T, Q> const& b
    )
{
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR qua <T, Q> operator+(qua < T, Q >
const& q)
{
return
q;
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<3, T, Q> operator*(qua < T, Q >
const& q,
vec<3, T, Q> const& v
)
{
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, T, Q> operator*(qua < T, Q >
const& q,
vec<4, T, Q> const& v
)
{
return
detail::compute_quat_mul_vec4<T, Q, detail::is_aligned<Q>::value>::call(q, v
);
}
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR bool operator==(qua < T, Q >
const& q1,
qua <T, Q> const& q2
)
{
...
{
return q1.x != q2.x || q1.y != q2.y || q1.z != q2.z || q1.w != q2.
w;
}
}//namespace glm

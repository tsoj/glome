...
namespace glm
{
    namespace detail
    {
        ...
        struct compute_linearRand<L, float, Q>
        {
            ...
            {
                return vec<L, float, Q>(compute_rand<L, uint32, Q>::call()) / static_cast<float>(std::numeric_limits<uint32>::max()) * (Max - Min) +
                       Min;
            }
        };
        ...
        struct compute_linearRand<L, double, Q>
        {
            ...
            {
                return vec<L, double, Q>(compute_rand<L, uint64, Q>::call()) / static_cast<double>(std::numeric_limits<uint64>::max()) * (Max - Min) +
                       Min;
            }
        };
        ...
        struct compute_linearRand<L, long double, Q>
        {
            ...
            {
                return vec<L, long double, Q>(compute_rand<L, uint64, Q>::call()) / static_cast<long double>(std::numeric_limits<uint64>::max()) *
                       (Max - Min) + Min;
            }
        };
    }//namespace detail

...
namespace rgba_16packed
{
    int test()
    {
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_332UNORM, true>::write(Texture,
                                                                                                                                              gli::texture2d_array::extent_type(
                                                                                                                                                  0),
                                                                                                                                              0, 0, 0,
                                                                                                                                              Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_332UNORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 2, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_44UNORM, true>::write(Texture,
                                                                                                                                             gli::texture2d_array::extent_type(
                                                                                                                                                 0),
                                                                                                                                             0, 0, 0,
                                                                                                                                             Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 2, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_44UNORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_4444UNORM, true>::write(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0, Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_4444UNORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_565UNORM, true>::write(Texture,
                                                                                                                                              gli::texture2d_array::extent_type(
                                                                                                                                                  0),
                                                                                                                                              0, 0, 0,
                                                                                                                                              Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_565UNORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_5551UNORM, true>::write(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0, Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_5551UNORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...
namespace rgba8_norm
{
    int test()
    {
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_CAST>::write(Texture,
                                                                                                                                    gli::texture2d_array::extent_type(
                                                                                                                                        0), 0, 0, 0,
                                                                                                                                    Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_CAST>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            gli::dvec4 const Color(1.0f, 0.5f, 0.0f, 1.0f);
            gli::texture2d_array Texture(gli::FORMAT_R8_UNORM_PACK8, gli::texture2d_array::extent_type(1), 1, 1);
            gli::detail::convertFunc<gli::texture2d_array, double, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                           gli::texture2d_array::extent_type(
                                                                                                                                               0), 0,
                                                                                                                                           0, 0,
                                                                                                                                           Color);
            gli::dvec4 Texel = gli::detail::convertFunc<gli::texture2d_array, double, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::texture2d_array Texture(gli::FORMAT_R8_USCALED_PACK8, gli::texture2d_array::extent_type(1), 1, 1);
            gli::detail::convertFunc<gli::texture2d_array, double, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_CAST, true>::write(Texture,
                                                                                                                                           gli::texture2d_array::extent_type(
                                                                                                                                               0), 0,
                                                                                                                                           0, 0,
                                                                                                                                           Color);
            gli::dvec4 Texel = gli::detail::convertFunc<gli::texture2d_array, double, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_CAST, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 1, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 1, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            gli::dvec4 const Color(1.0f, 0.5f, 0.0f, 1.0f);
            gli::texture2d_array Texture(gli::FORMAT_R8_SNORM_PACK8, gli::texture2d_array::extent_type(1), 1, 1);
            gli::detail::convertFunc<gli::texture2d_array, double, 1, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                           gli::texture2d_array::extent_type(
                                                                                                                                               0), 0,
                                                                                                                                           0, 0,
                                                                                                                                           Color);
            gli::dvec4 Texel = gli::detail::convertFunc<gli::texture2d_array, double, 1, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 2, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 2, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 2, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 2, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            gli::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::i8, gli::defaultp, gli::detail::CONVERT_MODE_NORM, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...
namespace rgba8_srgb
{
    int test()
    {
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            glm::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            gli::dvec4 const Color(1.0f, 0.5f, 0.0f, 1.0f);
            gli::texture2d_array Texture(gli::FORMAT_R8_SRGB_PACK8, gli::texture2d_array::extent_type(1), 1, 1);
            gli::detail::convertFunc<gli::texture2d_array, double, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::write(Texture,
                                                                                                                                           gli::texture2d_array::extent_type(
                                                                                                                                               0), 0,
                                                                                                                                           0, 0,
                                                                                                                                           Color);
            glm::dvec4 Texel = gli::detail::convertFunc<gli::texture2d_array, double, 1, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 2, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            glm::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 2, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            gli::dvec4 const Color(1.0f, 0.5f, 0.0f, 1.0f);
            gli::texture2d_array Texture(gli::FORMAT_RG8_SRGB_PACK8, gli::texture2d_array::extent_type(1), 1, 1);
            gli::detail::convertFunc<gli::texture2d_array, double, 2, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::write(Texture,
                                                                                                                                           gli::texture2d_array::extent_type(
                                                                                                                                               0), 0,
                                                                                                                                           0, 0,
                                                                                                                                           Color);
            glm::dvec4 Texel = gli::detail::convertFunc<gli::texture2d_array, double, 2, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            glm::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            gli::dvec4 const Color(1.0f, 0.5f, 0.0f, 1.0f);
            gli::texture2d_array Texture(gli::FORMAT_RGB8_SRGB_PACK8, gli::texture2d_array::extent_type(1), 1, 1);
            gli::detail::convertFunc<gli::texture2d_array, double, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::write(Texture,
                                                                                                                                           gli::texture2d_array::extent_type(
                                                                                                                                               0), 0,
                                                                                                                                           0, 0,
                                                                                                                                           Color);
            glm::dvec4 Texel = gli::detail::convertFunc<gli::texture2d_array, double, 3, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::write(Texture,
                                                                                                                                          gli::texture2d_array::extent_type(
                                                                                                                                              0), 0,
                                                                                                                                          0, 0,
                                                                                                                                          Color);
            glm::vec4 Texel = gli::detail::convertFunc<gli::texture2d_array, float, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            gli::dvec4 const Color(1.0f, 0.5f, 0.0f, 1.0f);
            gli::texture2d_array Texture(gli::FORMAT_RGBA8_SRGB_PACK8, gli::texture2d_array::extent_type(1), 1, 1);
            gli::detail::convertFunc<gli::texture2d_array, double, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::write(Texture,
                                                                                                                                           gli::texture2d_array::extent_type(
                                                                                                                                               0), 0,
                                                                                                                                           0, 0,
                                                                                                                                           Color);
            glm::dvec4 Texel = gli::detail::convertFunc<gli::texture2d_array, double, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_SRGB, true>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...
namespace rgb10a2norm
{
    int test()
    {
        ...
        Error += norm<double, glm::i8, 4, gli::detail::CONVERT_MODE_RGB10A2SNORM>::run(gli::FORMAT_RGB10A2_SNORM_PACK32,
                                                                                       gli::dvec4(1.0f, 0.5f, 0.0f, 1.0f));
        Error += norm<double, glm::u8, 4, gli::detail::CONVERT_MODE_RGB10A2USCALE>::run(gli::FORMAT_RGB10A2_USCALED_PACK32,
                                                                                        gli::dvec4(1023.f, 511.f, 0.f, 3.0f));
        Error += norm<double, glm::i8, 4, gli::detail::CONVERT_MODE_RGB10A2SSCALE>::run(gli::FORMAT_RGB10A2_SSCALED_PACK32,
                                                                                        gli::dvec4(511.f, 255.f, 0.f, 1.0f));
...
namespace rgb10a2int
{
    int test()
    {
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, gli::uint, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_RGB10A2UINT, false>::write(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0, Color);
            glm::uvec4 Texel = gli::detail::convertFunc<gli::texture2d_array, gli::uint, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_RGB10A2UINT, false>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);
...

        {
            ...
            gli::detail::convertFunc<gli::texture2d_array, int, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_RGB10A2SINT, false>::write(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0, Color);
            glm::ivec4 Texel = gli::detail::convertFunc<gli::texture2d_array, int, 4, glm::u8, gli::defaultp, gli::detail::CONVERT_MODE_RGB10A2SINT, false>::fetch(
                Texture, gli::texture2d_array::extent_type(0), 0, 0, 0);

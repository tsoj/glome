...
{
    static gli::texture1d_array
    make1d_array(gli::format Format, gli::texture1d_array::extent_type Extent, gli::texture1d_array::size_type Layers, glm::u8vec4 const& ClearColor)
    {
    ...
    static gli::texture2d_array
    make2d_array(gli::format Format, gli::texture2d_array::extent_type Extent, gli::texture2d_array::size_type Layers, glm::u8vec4 const& ClearColor)
    {
    ...
    static gli::texture_cube_array
    make_cube_array(gli::format Format, gli::texture2d_array::extent_type Extent, gli::texture2d_array::size_type Layers,
                    glm::u8vec4 const& ClearColor)
    {
    ...
    static int main()
    {
        ...
        // Texture 1d array
        {
            gli::texture1d_array const TextureExpected = make1d_array(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture1d_array::extent_type(8), 4,
                                                                      glm::u8vec4(193, 127, 0, 255));
        ...
        // Texture 2d array
        {
            gli::texture2d_array const Texture2DArrayExpected = make2d_array(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2d::extent_type(8), 4,
                                                                             glm::u8vec4(193, 127, 0, 255));

            // Scenario: Using gli::copy on a specialized texture 2d array to copy all images at once
            {
                gli::texture2d_array TextureScenario(Texture2DArrayExpected.format(), Texture2DArrayExpected.extent(),
                                                     Texture2DArrayExpected.layers());
        ...
        // Texture cube array
        {
            gli::texture_cube_array const TextureCubeMapExpected = make_cube_array(gli::FORMAT_RGBA8_UNORM_PACK8,
                                                                                   gli::texture_cube_array::extent_type(8), 4,
                                                                                   glm::u8vec4(193, 127, 0, 255));

            // Scenario: Using gli::copy on a specialized texture cube array to copy all images at once
            {
                gli::texture_cube_array TextureScenario(TextureCubeMapExpected.format(), TextureCubeMapExpected.extent(),
                                                        TextureCubeMapExpected.layers());
...
namespace can_copy_face_all_faces
{
    ...
    int main()
    {
        ...
        gli::texture_cube_array const TextureExpected = make_cube_array(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture_cube_array::extent_type(8), 4,
                                                                        glm::u8vec4(193, 127, 0, 255));
...
namespace can_copy_layer_all_layers
{
    ...
    int main()
    {
        ...
        gli::texture_cube_array const TextureCubeMapExpected = make_cube_array(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture_cube_array::extent_type(8),
                                                                               4, glm::u8vec4(193, 127, 0, 255));
...
namespace can_copy_full_copy
{
    int main()
    {
...

        {
            ...
            {
                gli::texture TextureScenario(gli::TARGET_1D, TextureExpected.format(), gli::texture::extent_type(TextureExpected.extent().x, 1, 1),
...

        {
            ...
            {
                gli::texture TextureScenario(gli::TARGET_1D_ARRAY, TextureExpected.format(),
                                             gli::texture::extent_type(TextureExpected.extent().x, 1, 1), TextureExpected.layers(),
                                             TextureExpected.faces(), TextureExpected.levels());
                Error += TextureExpected != TextureScenario ? 0 : 1;
...

        {
            ...
            {
                gli::texture TextureScenario(gli::TARGET_2D, TextureExpected.format(), gli::texture::extent_type(TextureExpected.extent(), 1),
                                             TextureExpected.layers(), TextureExpected.faces(), TextureExpected.levels());
                Error += TextureExpected != TextureScenario ? 0 : 1;
...

        {
            ...
            {
                gli::texture TextureScenario(gli::TARGET_2D_ARRAY, TextureExpected.format(), gli::texture::extent_type(TextureExpected.extent(), 1),
                                             TextureExpected.layers(), TextureExpected.faces(), TextureExpected.levels());
                Error += TextureExpected != TextureScenario ? 0 : 1;
...

        {
            ...
            {
                gli::texture TextureScenario(gli::TARGET_3D, TextureExpected.format(), TextureExpected.extent(), TextureExpected.layers(),
                                             TextureExpected.faces(), TextureExpected.levels());
                Error += TextureExpected != TextureScenario ? 0 : 1;
...

        {
            ...
            {
                gli::texture TextureScenario(gli::TARGET_CUBE, TextureExpected.format(), gli::texture::extent_type(TextureExpected.extent(), 1),
                                             TextureExpected.layers(), TextureExpected.faces(), TextureExpected.levels());
                Error += TextureExpected != TextureScenario ? 0 : 1;
...

        {
            ...
            {
                gli::texture TextureScenario(gli::TARGET_CUBE_ARRAY, TextureExpected.format(), gli::texture::extent_type(TextureExpected.extent(), 1),
                                             TextureExpected.layers(), TextureExpected.faces(), TextureExpected.levels());
                Error += TextureExpected != TextureScenario ? 0 : 1;

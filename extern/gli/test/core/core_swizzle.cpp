...
namespace swizzle
{
    int run()
    {
        ...
        {
            gli::texture Texture(gli::TARGET_2D, gli::FORMAT_BGRA8_UNORM_PACK8, gli::texture::extent_type(1), 1, 1, 1,
                                 gli::swizzles(gli::SWIZZLE_BLUE, gli::SWIZZLE_GREEN, gli::SWIZZLE_RED, gli::SWIZZLE_ALPHA));
            gli::texture::swizzles_type const Swizzles = Texture.swizzles();
            Error += Swizzles == gli::swizzles(gli::SWIZZLE_RED, gli::SWIZZLE_GREEN, gli::SWIZZLE_BLUE, gli::SWIZZLE_ALPHA) ? 0 : 1;
        }
...
namespace texture1d
{
    int run()
    {
...

        {
            ...
            gli::texture1d TextureA2(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture1d::extent_type(4), 1,
                                     gli::swizzles(gli::SWIZZLE_RED, gli::SWIZZLE_GREEN, gli::SWIZZLE_BLUE, gli::SWIZZLE_ALPHA));
...
namespace texture1d_array
{
    int run()
    {
...

        {
            ...
            gli::texture1d_array TextureA2(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture1d_array::extent_type(4), 1, 1,
                                           gli::swizzles(gli::SWIZZLE_RED, gli::SWIZZLE_GREEN, gli::SWIZZLE_BLUE, gli::SWIZZLE_ALPHA));
            Error += TextureA.swizzles() == TextureA2.swizzles() ? 0 : 1;
...
namespace texture2d
{
    int run()
    {
...

        {
            ...
            gli::texture2d TextureA2(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2d::extent_type(4), 1,
                                     gli::swizzles(gli::SWIZZLE_RED, gli::SWIZZLE_GREEN, gli::SWIZZLE_BLUE, gli::SWIZZLE_ALPHA));
            Error += TextureA.swizzles() == TextureA2.swizzles() ? 0 : 1;
...
namespace texture2d_array
{
    int run()
    {
...

        {
            ...
            gli::texture2d_array TextureA2(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2d_array::extent_type(4), 1, 1,
                                           gli::swizzles(gli::SWIZZLE_RED, gli::SWIZZLE_GREEN, gli::SWIZZLE_BLUE, gli::SWIZZLE_ALPHA));
            Error += TextureA.swizzles() == TextureA2.swizzles() ? 0 : 1;
...
namespace texture3d
{
    int run()
    {
...

        {
            ...
            gli::texture3d TextureA2(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture3d::extent_type(4), 1,
                                     gli::swizzles(gli::SWIZZLE_RED, gli::SWIZZLE_GREEN, gli::SWIZZLE_BLUE, gli::SWIZZLE_ALPHA));
            Error += TextureA.swizzles() == TextureA2.swizzles() ? 0 : 1;
...
namespace texture_cube
{
    int run()
    {
...

        {
            ...
            gli::texture_cube TextureA2(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture_cube::extent_type(4), 1,
                                        gli::swizzles(gli::SWIZZLE_RED, gli::SWIZZLE_GREEN, gli::SWIZZLE_BLUE, gli::SWIZZLE_ALPHA));
            Error += TextureA.swizzles() == TextureA2.swizzles() ? 0 : 1;
...
namespace texture_cube_array
{
    int run()
    {
...

        {
            ...
            gli::texture_cube_array TextureA2(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture_cube_array::extent_type(4), 1, 1,
                                              gli::swizzles(gli::SWIZZLE_RED, gli::SWIZZLE_GREEN, gli::SWIZZLE_BLUE, gli::SWIZZLE_ALPHA));
            Error += TextureA.swizzles() == TextureA2.swizzles() ? 0 : 1;

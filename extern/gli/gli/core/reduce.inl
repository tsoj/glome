...
namespace gli
{
    ...
    namespace detail
    {
        ...
        struct compute_sampler_reduce_1d_array
        {
            ...
            static vec<4, val_type>
            call(texture1d_array const& A, texture1d_array const& B, binary_func<val_type> TexelFunc, binary_func<val_type> ReduceFunc)
            {
                GLI_ASSERT(are_compatible(A, B));
        ...
        struct compute_sampler_reduce_2d_array
        {
            ...
            static vec<4, val_type>
            call(texture2d_array const& A, texture2d_array const& B, binary_func<val_type> TexelFunc, binary_func<val_type> ReduceFunc)
            {
                GLI_ASSERT(are_compatible(A, B));
        ...
        struct compute_sampler_reduce_cube
        {
            ...
            static vec<4, val_type>
            call(texture_cube const& A, texture_cube const& B, binary_func<val_type> TexelFunc, binary_func<val_type> ReduceFunc)
            {
                GLI_ASSERT(are_compatible(A, B));
        ...
        struct compute_sampler_reduce_cube_array
        {
            ...
            static vec<4, val_type>
            call(texture_cube_array const& A, texture_cube_array const& B, binary_func<val_type> TexelFunc, binary_func<val_type> ReduceFunc)
            {
                GLI_ASSERT(are_compatible(A, B));
    ...
    template<typename vec_type>
    inline vec_type reduce(texture_cube_array const& In0, texture_cube_array const& In1, typename reduce_func<vec_type>::type TexelFunc,
                           typename reduce_func<vec_type>::type ReduceFunc)
    {

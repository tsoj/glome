...
namespace gli
{
    namespace detail
    {
        ...
        inline void single_channel_bitmap_data_unorm(uint8_t Channel0, uint8_t Channel1, const uint8_t* ChannelBitmap, float* LookupTable,
        ...
        inline void single_channel_bitmap_data_snorm(uint8_t Channel0, uint8_t Channel1, const uint8_t* ChannelBitmap, float* LookupTable,
                                                     uint64_t& ContiguousBitmap)
        {
        ...
        inline void
        single_channel_bitmap_data_snorm(uint8_t Channel0, uint32_t Channel1, bool Interpolate6, const uint8_t* ChannelBitmap, float* LookupTable,
                                         uint64_t& ContiguousBitmap)
        {
            LookupTable[0] = (Channel0 / 255.0f) * 2.0f - 1.0f;
            LookupTable[1] = (Channel1 / 255.0f) * 2.0f - 1.0f;

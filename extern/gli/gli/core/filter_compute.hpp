...
namespace gli
{
    namespace detail
    {
        ...
        struct nearest : public filterBase<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
            ...
            static texel_type
            call(texture_type const& Texture, fetch_type Fetch, normalized_type const& SampleCoordWrap, size_type Layer, size_type Face,
                 size_type Level, texel_type const& BorderColor)
            {
            ...
            : public filterBase<DIMENSION_3D, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
                 ...
                 size_type Level, texel_type const& BorderColor)
            {
                ...
                texel_type const& Texel000 = Fetch(Texture, extent_type(Coord.TexelFloor.s, Coord.TexelFloor.t, Coord.TexelFloor.p), Layer, Face,
                                                   Level);
                texel_type const& Texel100 = Fetch(Texture, extent_type(Coord.TexelCeil.s, Coord.TexelFloor.t, Coord.TexelFloor.p), Layer, Face,
                                                   Level);
                texel_type const& Texel110 = Fetch(Texture, extent_type(Coord.TexelCeil.s, Coord.TexelCeil.t, Coord.TexelFloor.p), Layer, Face,
                                                   Level);
                texel_type const& Texel010 = Fetch(Texture, extent_type(Coord.TexelFloor.s, Coord.TexelCeil.t, Coord.TexelFloor.p), Layer, Face,
                                                   Level);
                texel_type const& Texel001 = Fetch(Texture, extent_type(Coord.TexelFloor.s, Coord.TexelFloor.t, Coord.TexelCeil.p), Layer, Face,
                                                   Level);
                texel_type const& Texel101 = Fetch(Texture, extent_type(Coord.TexelCeil.s, Coord.TexelFloor.t, Coord.TexelCeil.p), Layer, Face,
                                                   Level);
                ...
                texel_type const& Texel011 = Fetch(Texture, extent_type(Coord.TexelFloor.s, Coord.TexelCeil.t, Coord.TexelCeil.p), Layer, Face,
                                                   Level);
        ...
        struct nearest_mipmap_nearest : public filterBase<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
            ...
            static texel_type
            call(texture_type const& Texture, fetch_type Fetch, normalized_type const& SampleCoordWrap, size_type Layer, size_type Face,
                 interpolate_type Level, texel_type const& BorderColor)
            {
                return nearest<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type, is_float, support_border>::call(
                    Texture, Fetch, SampleCoordWrap, Layer, Face, glm::iround(Level), BorderColor);
            }
        };
        ...
        struct nearest_mipmap_linear : public filterBase<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
            ...
            call(texture_type const& Texture, fetch_type Fetch, normalized_type const& SampleCoordWrap, size_type Layer, size_type Face,
                 interpolate_type Level, texel_type const& BorderColor)
            {
                texel_type const MinTexel = nearest<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type, is_float, support_border>::call(
                    Texture, Fetch, SampleCoordWrap, Layer, Face, static_cast<size_type>(floor(Level)), BorderColor);
                texel_type const MaxTexel = nearest<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type, is_float, support_border>::call(
                    Texture, Fetch, SampleCoordWrap, Layer, Face, static_cast<size_type>(ceil(Level)), BorderColor);
        ...
        struct linear_mipmap_nearest : public filterBase<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
            ...
            call(texture_type const& Texture, fetch_type Fetch, normalized_type const& SampleCoordWrap, size_type Layer, size_type Face,
                 interpolate_type Level, texel_type const& BorderColor)
            {
                return linear<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type, is_float, support_border>::call(
                    Texture, Fetch, SampleCoordWrap, Layer, Face, glm::iround(Level), BorderColor);
            }
        };
        ...
        struct linear_mipmap_linear : public filterBase<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
                 ...
                 interpolate_type Level, texel_type const& BorderColor)
            {
                ...
                texel_type const MinTexel = linear<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type, is_float, support_border>::call(
                    Texture, Fetch, SampleCoordWrap, Layer, Face, FloorLevel, BorderColor);
                texel_type const MaxTexel = linear<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type, is_float, support_border>::call(
                    Texture, Fetch, SampleCoordWrap, Layer, Face, CeilLevel, BorderColor);
                return mix(MinTexel, MaxTexel, fract(Level));
            }
        };

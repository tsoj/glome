namespace gli
{
    ...
    inline image::image()
        : Format(gli::FORMAT_UNDEFINED), BaseLevel(0), Data(nullptr), Size(0)
    {}
    ...
    inline image::image
        ...
        : Storage(std::make_shared<storage_linear>(Format, Extent, 1, 1, 1)), Format(Format), BaseLevel(0), Data(Storage->data()),
          Size(compute_size(0))
    {}
    ...
    inline image::image
        ...
        : Storage(Storage), Format(Format), BaseLevel(BaseLevel), Data(compute_data(BaseLayer, BaseFace, BaseLevel)), Size(compute_size(BaseLevel))
    {}

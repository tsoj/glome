...
namespace gli
{
    namespace workaround
    {
        namespace detail
        {
            ...
            {
                GLM_FUNC_QUALIFIER static tvec1<uint16, P>
                pack(tvec1<float, P> const & v)
                {
                    int16 const Unpacked(glm::detail::toFloat16(v.x));
                    return tvec1 < uint16, P > (reinterpret_cast<uint16 const&>(Unpacked));
                }

                GLM_FUNC_QUALIFIER static tvec1<float, P>
                unpack(tvec1<uint16, P> const & v)
                {
            ...
            {
                GLM_FUNC_QUALIFIER static tvec2<uint16, P>
                pack(tvec2<float, P> const & v)
                {
                ...
                GLM_FUNC_QUALIFIER static tvec2<float, P>
                unpack(tvec2<uint16, P> const & v)
                {
            ...
            {
                GLM_FUNC_QUALIFIER static tvec3<uint16, P>
                pack(tvec3<float, P> const & v)
                {
                ...
                GLM_FUNC_QUALIFIER static tvec3<float, P>
                unpack(tvec3<uint16, P> const & v)
                {
            ...
            {
                GLM_FUNC_QUALIFIER static vec<4, uint16, P>
                pack(vec<4, float, P> const & v)
                {
                    vec<4, int16, P> const Unpacked(glm::detail::toFloat16(v.x), glm::detail::toFloat16(v.y), glm::detail::toFloat16(v.z),
                                                    glm::detail::toFloat16(v.w));
                ...
                GLM_FUNC_QUALIFIER static vec<4, float, P>
                unpack(vec<4, uint16, P> const & v)
                {
...
GLM_FUNC_QUALIFIER vecType<uintType, P>
...
return
vecType<uintType, P>(round(
    clamp(v, static_cast<floatType>(0), static_cast<floatType>(1)) * static_cast<floatType>(std::numeric_limits<uintType>::max()))
);
}
...
return
vec3(Unpack
.data.x, Unpack.data.y, Unpack.data.z) *
ScaleFactor;
}
...
return
vec4(Unpack
.data.x, Unpack.data.y, Unpack.data.z, Unpack.data.w) *
ScaleFactor;
}

GLM_FUNC_QUALIFIER uint16
packUnorm3x5_1x1(vec4
const & v)
{
...
return
vec3(Unpack
.data.x, Unpack.data.y, Unpack.data.z) * pow(2.0f, Unpack.data.w - 15.f - 9.f);
}

template<precision P, template<typename, precision> class vecType>
GLM_FUNC_QUALIFIER vecType<uint16, P>
packHalf(vecType<float, P>
const & v)
{
return
detail::compute_half<P, vecType>::pack(v);
}
...
{
return
detail::compute_half<P, vecType>::unpack(v);
}
}//namespace workaround
}//namespace gli

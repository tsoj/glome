...
namespace gli
{
    ...
    sampler2d_array<T, P>::texel_fetch(extent_type const& TexelCoord, size_type layer, size_type Level) const
    {
    ...
    template<typename T, qualifier P>
    inline typename sampler2d_array<T, P>::texel_type
    sampler2d_array<T, P>::texture_lod(normalized_type const& SampleCoord, size_type Layer, level_type Level) const
    {
        GLI_ASSERT(!this->Texture.empty());
    ...
    template<typename T, qualifier P>
    inline void
    sampler2d_array<T, P>::generate_mipmaps(size_type BaseLayer, size_type MaxLayer, size_type BaseLevel, size_type MaxLevel, filter Minification)
    {
        GLI_ASSERT(!this->Texture.empty());
